...
* Goals Overview
 ...
 The Project Info Reports Plugin has the following goals:
   ...
   * {{{./ci-management-mojo.html}project-info-reports:ci-management}} is used to generate the Project Continuous Integration
   Management report.
   ...
   * {{{./dependency-info-mojo.html}project-info-reports:dependency-info}} is used to generate code snippets
   of the Maven coordinates to be added to build tools.
   ...
   * {{{./help-mojo.html}project-info-reports:help}} is used to display help information
   on the Project Info Reports Plugin.

   * {{{./index-mojo.html}project-info-reports:index}} is used to generate the Project index page.

   * {{{./issue-management-mojo.html}project-info-reports:issue-management}} is used to generate the Project Issue
   Management report.

   * {{{./licenses-mojo.html}project-info-reports:licenses}} is used to generate the Project Licenses report.

   * {{{./mailing-lists-mojo.html}project-info-reports:mailing-lists}} is used to generate the Project Mailing
   Lists report.
   ...
   * {{{./team-mojo.html}project-info-reports:team}} is used to generate the Project Team report.

   * {{{./scm-mojo.html}project-info-reports:scm}} is used to generate the Project Source Code Management report.

   * {{{./summary-mojo.html}project-info-reports:summary}} is used to generate the Project Summary report.

* Upcoming Incompatibility Notice

  With a future version mojos and output filenames will change for consistency alignment.
  See the following table for the upcoming changes:
...
* Examples
  ...
  * {{{./examples/selective-reports.html}Run Selective Reports}}
...
* Related Links
  ...
  * {{{http://maven.apache.org/plugins/maven-site-plugin/examples/creatingskins.html}Create a layout (skin))}}

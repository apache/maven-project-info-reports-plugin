...
assert logContent.contains('JarDataSummary cached for: org.apache.commons:commons-math3:jar:tools:3.6.1:compile');
assert logContent.contains('JarDataSummary cached for: org.apache.maven.its.mpir-465:snapshot-test:jar:1.0-SNAPSHOT:compile')
assert logContent.contains('JarDataSummary cached for: org.codehaus.plexus:plexus-utils:jar:4.0.0:compile')

assert !logContent.contains('JarDataSummary analyzed for:')
